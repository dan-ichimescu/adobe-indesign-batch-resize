...
for (var r = 1; r < dataList.length; r++) {
    ...
    var CountNumber = padWithZeros(r, numberOfFiles)
    // FINAL NAME
    // var finalFileName = cleanMydata(finalFileNameRaw);
    var finalFileName = CountNumber + "_" + NameOfMyCampain + "_" + material_places + "__" + dataList[r][4] + "x" + dataList[r][5] + "_" + dataList[r][2] + "x" + dataList[r][3] + "_" + KVname;
...
function aliniereElemente(vizibil_W, vizibil_H, total_W, total_H) { // + redefine Scaling
    ...
    for (var i = 0; i < myObjectList.length; i++) {
        ...
        var myBoundsFrame = myObjectList[i].geometricBounds;  // HW dreptunghi alb
