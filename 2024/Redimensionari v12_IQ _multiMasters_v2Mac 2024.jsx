...
for (var r = 0; r < dataList.length; r++) {
  ...
  var finalFileName =
    ...
    material_places +
    "__" +
    Number(dataList[r][4]) * 10 +
    "x" +
    Number(dataList[r][5]) * 10 +
    "_" +
    Number(dataList[r][2]) * 10 +
    "x" +
    Number(dataList[r][3]) * 10 +
    "_" +
    KVname;
...
function aliniereHwDocument() {
  ...
  function dti40() {
    ...
    var myDTai = app.documents[0].rectangles
      .itemByName("dt4")
      .rectangles.itemByName("dt4ai"); //
    // linedthw
